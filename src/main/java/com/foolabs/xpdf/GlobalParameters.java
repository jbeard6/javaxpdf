...
/**
 * Java abstraction for the Xpdf GlobalParams class.
 * 
 * Warning: this is a singleton instance across the ENTIRE JVM! Options set here will affect ALL users of Xpdf in the
 * JVM.
 */
public class GlobalParameters {
    ...
    public static GlobalParameters getInstance() {
        if (INSTANCE == null) {
            ...
            INSTANCE._setTextEncoding("UTF-8"); // Initialize with UTF-8 encoding
            INSTANCE._setTextEOL(EndOfLine.UNIX.value);
            INSTANCE._setTextPageBreaks(true);
        }
    ...
    /**
     * Returns the {@link Charset} that will be used for reading {@link PDFDocument} text.
     * 
     * @return the character set
     * @throws UnsupportedCharsetException if the {@link Charset} is not supported by this JVM
     */
    ...
    /**
     * Sets the {@link Charset} that will be used for reading {@link PDFDocument} text.
     * 
     * @param charset the character set
     * @throws NullPointerException if the {@link Charset} is <code>null</code>
     */
    ...
    /**
     * Returns the name of the {@link Charset} that will be used for reading {@link PDFDocument} text.
     * 
    ...
    /**
     * Returns the native value for the {@link EndOfLine} from the native object.
     * 
     ...
     * 
     * @param eol the native {@link EndOfLine} value
     */
    private native void _setTextEOL(String eol);

    /**
     * Returns <code>true</code> if a form feed character will be written between {@link PDFPage#getText() page text}.
     * 
    ...
    /**
     * Returns <code>true</code> if page content is to be split according to the native object.
     * 
     * @return <code>true</code> if page content is to be split
     */
    ...
    /**
     * Sets if a form feed character will be written between {@link PDFPage#getText() page text}.
     * 
     * @param breakBetweenPages <code>true</code> if page content is to be split
     */
     ...
     * 
     * @param textPageBreaks <code>true</code> if page content is to be split
     */
    ...
    /**
     * Returns <code>true</code> if error output is suppressed according to the native object.
     * 
     * @return <code>true</code> if error output is suppressed
     */
     ...
     * 
     * @param errorOutputSuppressed <code>true</code> if error output should be suppressed
     */
     ...
     * 
     * @param errQuiet <code>true</code> if error output should be suppressed
     */
