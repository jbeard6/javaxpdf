...
/**
 * Java abstraction for the Xpdf GlobalParams class. Warning: this is a singleton instance across the ENTIRE JVM!
 * Options set here will affect ALL users of Xpdf in the JVM.
 */
